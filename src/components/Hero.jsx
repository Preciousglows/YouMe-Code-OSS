...
function Hero(){
    return (
        <>
        <div className=" flex flex-col md:h-[80vh] justify-center items-center pb-5 gap-5">
            ...
            <h2 className="text-white md:text-2xl w-3/4 text-center md:w-1/2">Discover coding challenges, connect with a vibrant community, and level up your skills!</h2>
